...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=4)
        Button(root, text='Seat Booking', font='Arial 14 bold', bg='green3', fg='black',command=home_to_jouney_detail).grid(row=4, column=4)
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=6)
        ...
        Label(root, text='\n\n\n\n\n\n').grid(row=3, column=8)
        Button(root, text='Add Bus Details', font='Arial 14 bold', bg='green3', fg='black',command=home_to_db_add_page ).grid(row=4, column=8)
        Label(root, text='\n').grid(row=5, column=8)
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: ASHIKA", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B069", font='Arial 16 bold', fg='blue').pack()
                    ...
                    if len(res_route)==0:
                        ...
                        if len(res_bid)==0:
                            ...
                            if len(b)==0:
                                ...
                                Label(root,text='select bus ',font='Arial 10 bold').grid(row=5,column=3)
                                Label(root, text='operator ', font='Arial 10 bold').grid(row=5, column=4)
                                Label(root, text='bus_type ', font='Arial 10 bold').grid(row=5, column=5)
                                Label(root, text='Available Capacity ', font='Arial 10 bold').grid(row=5, column=6)
                                Label(root, text='fare ', font='Arial 10 bold').grid(row=5, column=7)
                                r=7
                                bus_no=IntVar()
                                bus_select = IntVar()
                                serial_no=1
                                ...
                                def proceed():
                                    ...
                                    Label(root,text="\n\n\n").grid(row=9,columnspan=9)
                                    Label(root,text='Fill passenger details to book the bus', bg='light green', fg='dark green', font='Arial 18 bold').grid(row=9,columnspan=9)
                                    Label(root, text="\n\n\n").grid(row=9,columnspan=9)
                                    ...
                                    Label(root, text='mobile', font='Arial 10 bold').grid(row=12, column=3)
                                    pmobile = Entry(root, font='Arial 12 bold', fg='black')
                                    pmobile.grid(row=12, column=4)

                                    Label(root, text='age', font='Arial 10 bold').grid(row=12, column=5)
                                    page = Entry(root, font='Arial 12 bold', fg='black')
                                    page.grid(row=12, column=6)
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<6:
                                                        ...
                                                        Label(text="YOUR TICKET", font='Arial 12 bold', bg='blue',fg='white').grid(row=14,columnspan=12 )
                                                        Label(text="booking ref = "+b_ref,font='Arial 12 bold', fg='blue').grid(row=15,column=4)
                                                        Label(text="name = " + name, font='Arial 12 bold', fg='blue').grid(row=15, column=5)
                                                        Label(text="gender = " + gen, font='Arial 12 bold', fg='blue').grid(row=15, column=6)
                                                        Label(text="no of seats = " + str(seat), font='Arial 12 bold', fg='blue').grid(row=15, column=7)
                                                        Label(text="age = " + str(age), font='Arial 12 bold', fg='blue').grid(row=15, column=8)
                                                        Label(text="booked on = " + book_date, font='Arial 12 bold', fg='blue').grid(row=16, column=4)
                                                        Label(text="travel date = " + travel_date, font='Arial 12 bold', fg='blue').grid(row=16, column=5)
                                                        Label(text="fare = " + str(fare), font='Arial 12 bold', fg='blue').grid(row=16, column=6)
                                                        Label(text="total fare = " + str(fare*seat), font='Arial 12 bold', fg='blue').grid(row=16, column=7)
                                                        Label(text="seat available = " + str(s), font='Arial 12 bold', fg='blue').grid(row=16, column=8)
                                    ...
                                    Button(root, text='BOOK SEAT', bg='green', fg='black', font='Arial 12 bold',
                                           command=book_seat).grid(row=14, column=9, padx=30)
